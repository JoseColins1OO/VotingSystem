				    ...
				    <?php
				    	...
				    	if($vquery->num_rows > 0){
				    		...
				    		<div class="text-center" style="color:black ; font-size: 35px; font-family:Times" >
					    		...
					    		<a href="#view" data-toggle="modal" class="btn btn-curve btn-primary btn-lg" style="background-color: #4682B4 ;color:black ; font-size: 22px; font-family:Times">Ver Boleta</a>
					    	</div>
				    		<?php
				    	}
				    	else{
