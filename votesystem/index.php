...
<div class="login-box" style="background-color: #A69F8B; color: white; font-size: 22px; font-family: 'Times New Roman', Times, serif;">
   ...
   <div class="login-box-body" style="background-color: #A69F8B; color: white; font-size: 22px; font-family: 'Times New Roman', Times, serif;">
        <p class="login-box-msg" style="color: #2E4D3A; font-size: 16px; font-family: 'Times New Roman', Times, serif;">Inicie sesión como administrador</p>

        <form action="login.php" method="POST">
            <div class="form-group has-feedback">No Cuenta
                <input type="text" class="form-control" name="voter" placeholder="Voter's ID / No de cuenta " required>
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input type="password" class="form-control" name="password" placeholder="Contrasenia" required>
                <span class="glyphicon glyphicon-lock form-control-feedback"></span>
            </div>
            <div class="row">
                <div class="col-xs-12">
                    <button type="submit" class="btn btn-primary btn-block" style="background-color: #006341; color: white; font-size: 16px; font-family: 'Times New Roman', Times, serif;" name="login"><i class="fa fa-sign-in"></i> Iniciar sesión
                    </button>
                </div>
            </div>
        </form>
