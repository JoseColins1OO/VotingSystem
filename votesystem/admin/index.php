...
<div class="login-box" style="background-color:#a69f8b ;color:white ; font-size: 22px; font-family:Times">
  	...
  	<div class="login-box-body"style="background-color:#a69f8b ;color:white ; font-size: 22px; font-family:Times  " >
    	<p class="login-box-msg" style="color:black ; font-size: 16px; font-family:Times  " >Inicie sesión como administrador</p>
    	...
    	<form action="login.php" method="POST">
          ...
          <div class="form-group has-feedback">
            ...
            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      		...
      		<div class="row">
    			<div class="col-xs-5">
          			<button type="submit" class="btn btn-primary btn-block btn-curve"style="background-color: #4682B4 ;color:black ; font-size: 12px; font-family:Times"  name="login"><i class="fa fa-sign-in"></i> Iniciar sesion</button>
        		</div>
      		</div>
    	</form>
  	</div>
