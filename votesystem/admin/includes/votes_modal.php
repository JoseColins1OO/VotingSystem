    ...
    <div class="modal-dialog">
        <div class="modal-content" style="background-color: #d8d1bd ;color:black ; font-size: 15px; font-family:Times ">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><b>Reiniciando...</b></h4>
            </div>
            <div class="modal-body">
              <div class="text-center">
                  <p>Reiniciar Votos</p>
                  <h4>Esto eliminará todos los votos y contará hasta 0.</h4>
              </div>
            </div>
            <div class="modal-footer">
              ...
              <a href="votes_reset.php" class="btn btn-danger btn-curve"style='background-color:  #ff8e88  ;color:black ; font-size: 12px; font-family:Times' ><i class="fa fa-refresh"></i> Reiniciar</a>
            </div>
        </div>
    </div>
</div>